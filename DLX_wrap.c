...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__DLX

#else
#  define SWIG_init    init_DLX

#endif
#define SWIG_name    "_DLX"
...
SWIGINTERN PyObject *_wrap_DLXsolve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:DLXsolve",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DLXsolve" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  DLXsolve(arg1);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_DLXgenerate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:DLXgenerate",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "DLXgenerate" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "DLXgenerate" "', argument " "2"" of type '" "int *""'"); 
  }
  arg2 = (int *)(argp2);
  DLXgenerate(arg1,arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"DLXsolve", _wrap_DLXsolve, METH_VARARGS, NULL},
	 { (char *)"DLXgenerate", _wrap_DLXgenerate, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
